...
Every number below comes from controlled same-model A/B runs — the same brain,
with and without Libra OS — certified across three repetitions. The gain is the
system layer, not a bigger model.
